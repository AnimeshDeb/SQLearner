...
const CATEGORY_MAP: Record<string, number[]> = {
  ...
  "Basic Aggregation & Grouping": [2, 7, 9, 32, 33, 37, 40, 41, 45, 50, 51, 69],
  "Joins & Set Operations": [3, 4, 10, 11, 15, 16, 55, 70],
  "String, Date & Time Manipulation": [5, 36, 39, 48, 53, 25],
  "Window Functions": [6, 8, 12, 13, 14, 17, 18, 19, 24, 26, 28, 43, 52, 54, 58, 60, 68, 77, 85],
  "Recursive & Hierarchical Data": [22, 23, 74, 75, 81, 88],
  "Advanced Analytics & Business Logic": [20, 21, 27, 29, 30, 56, 57, 59, 61, 62, 63, 64, 65, 66, 67, 71, 72, 73, 76, 78, 79, 80, 82, 83, 84, 86, 87, 89, 90]
};
